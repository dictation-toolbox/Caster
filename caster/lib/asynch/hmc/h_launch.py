...
try:  # Style C -- may be imported into Caster, or externally
    ...
    from caster.lib.asynch.hmc.hmc_ask_directory import HomunculusDirectory
    from caster.lib.asynch.hmc.hmc_recording import HomunculusRecording
    from caster.lib.asynch.hmc.hmc_confirm import HomunculusConfirm
    from caster.lib.asynch.hmc.homunculus import Homunculus
