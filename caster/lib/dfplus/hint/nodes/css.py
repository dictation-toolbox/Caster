...
H = hintnode.HintNode
_style = H("style",Text("-style: "), [H("none",Text("none")),H("hidden",Text("hidden")),
                                         H("dotted",Text("dotted")),H("dashed",Text("dashed")),   
                                         H("solid",Text("solid")),H("double",Text("double")),
                                         H("groove",Text("groove")),H("ridge",Text("ridge")),
...
def _get_speech():
    _volume = [H("uri",Text("uri")),H("silent",Text("silent")),H("extra soft", Text("x-soft") ),
               H("soft",Text("soft")),H("medium",Text("medium")),H("loud",Text("loud")),
               H("extra loud", Text("x-loud")),H("none",Text("none")),H("inherit",Text("inherit"))
               ]
    _pause_rest = [H("none",Text("none")),H("extra weak", Text("x-weak")),H("weak",Text("weak")), 
                   H("medium",Text("medium")),H("strong",Text("strong")),H("extra strong", Text("x-strong")),
                   H("inherit",Text("inherit"))
                   ]
    _pitch = [H("extra low", Text("x-low")),H("low",Text("low")),
    ...
    return H("speech",NullAction(), [
            ...
            H("speak", Text("speak: "), [
                          H("none",Text("none")),H("normal",Text("normal")),H("spell out", Text("spell-out")),
                          H("digits",Text("digits")),H("literal punctuation", Text("literal-punctuation")),
                          H("no punctuation", Text("no-punctuation")),H("inherit",Text("inherit"))
                          ]),
            H("voice",Text("voice"), [
                        H("balance", Text("-balance: "), [
                              H("left",Text("left")),H("center",Text("center")),H("right",Text("right")),H("leftwards",Text("leftwards")),
                              H("rightwards",Text("rightwards")),H("inherit",Text("inherit"))
                              ]),
                        H("duration", Text("-duration: ")), 
                        H("family", Text("-family: "), [H("inherit",Text("inherit"))]),
                        H("rate", Text("-rate: "), [
                                      H("extra low", Text("x-low")),H("low",Text("low")),H("medium",Text("medium")),
                                      H("fast",Text("fast")),H("next for fast", Text("x-fast")),H("inherit",Text("inherit")),
                                      ]),
                        H("pitch", Text("-pitch: "), _pitch),
                        H("pitch range", Text("-pitch-range: "), _pitch),
                        H("stress", Text("-stress: "), [
                                        H("strong",Text("strong")),H("moderate",Text("moderate")),H("none",Text("none")),
                                        H("reduced",Text("reduced")),H("inherit",Text("inherit"))
                                        ]),
...
def _get_text():
    ...
    return H("text",Text("text"), [
                      ...
                      H("shadow", Text("-shadow: "), [H("none",Text("none")),H("color",Text("COLOR"))]),
...
def _get_box_model():# display can be optimized by doing more nesting, this whole section is to be moved somewhere else 
    ...
    _sides = [H("top", Text("-top: "), _auto),
              H("bottom", Text("-bottom: "), _auto),
              H("left", Text("-left: "), _auto),
              H("right", Text("-right: "), _auto)
              ]
    _overflow = [H("visible",Text("visible")),H("hidden",Text("hidden")),H("scroll",Text("scroll")),
    ...
    return H("box model", NullAction(), [
                  ...
                  H("display", Text("display: "), [
                                  H("none",Text("none")),H("block",Text("block")),
                                  H("compact",Text("compact")),H("table",Text("table")),
                  ...
                  H("marquee",Text("marquee"), [
                                ...
                                H("speed", Text("-speed: "), [
                                               H("slow",Text("slow")),H("normal",Text("normal")),H("fast",Text("fast"))
                                               ]),
                                H("style", Text("-style: "), [H("scroll",Text("scroll")),H("slide",Text("slide")),H("alternate",Text("alternate"))])
                                ]),
...
def _get_border():
    H = hintnode.HintNode
    _width = H("width", Text("-width: "), [H("thin",Text("thin")), H("medium",Text("medium")), H("thick",Text("thick"))])
    global _style
    _color = H("color", Text("-color: "), [H("color", Text("COLOR"))])
    _radius = H("radius", Text("-radius: "))
    return H("border", Text("border"), [ _width, _style, _color, 
                        H("top", Text("-top"), [_width, _style, _color, 
                                   H("left", Text("-left"), [_radius]), 
                                   H("right", Text("-right"), [_radius])
                                   ]), 
                        H("bottom", Text("-bottom"), [_width, _style, _color, 
                                   H("left", Text("-left"), [_radius]), 
                                   H("right", Text("-right"), [_radius])
                                      ]),
                        H("left", Text("-left"), [_width, _style, _color]),
                        H("right", Text("-right"), [_width, _style, _color]),
                        H("break", Text("-break"), [_width, _style, _color, 
                                     H("close",Text("close"))]), 
                        H("collapse", Text("-collapse: "), [
                                          H("collapse",Text("collapse")),
...
def _get_background():
    H = hintnode.HintNode
    halign = [H("left",Text("left")), H("center",Text("center")), H("right",Text("right"))]
    background_position = halign+[
        H("X position", Text("xpos")), 
        H("Y position", Text("ypos")), 
        H("initial",Text("initial")), H("inherit",Text("inherit"))]
    background_box = [
            H("border box", Text("border-box")), 
            H("padding box", Text("padding-box")),
            H("border box", Text("border-box")),
    ...
    return H("background",Text("background"), [
        ...
        H("size", Text("-size: "), [H("auto",Text("auto")), H("cover",Text("cover")), H("contain",Text("contain"))]),
