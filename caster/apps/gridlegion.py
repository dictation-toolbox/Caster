...
class GridControlRule(MappingRule):
    ...
    mapping = {
        ...
        "refresh":                          R(Function(navigation.mouse_alternates, mode="legion", nexus=_NEXUS), rdescript="Legion: Refresh"),
        "exit | escape | cancel":           R(Function(kill, nexus=_NEXUS), rdescript="Exit Legion"),
