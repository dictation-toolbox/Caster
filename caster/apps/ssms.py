...
class CommandRule(MappingRule):
    ...
    mapping = {
        ...
        "next tab [<n>]":               R(Key("c-tab"), rdescript="SSMS: Next Tab") * Repeat(extra="n"),
        "prior tab [<n>]":              R(Key("cs-tab"), rdescript="SSMS: Previous Tab") * Repeat(extra="n"),
        "close tab [<n>]":              R(Key("c-f4/20"), rdescript="SSMS: Close Tab") * Repeat(extra="n"),
        ...
        "step over [<n>]":              R(Key("f10/50") * Repeat(extra="n"), rdescript="SSMS: Step Over"),
