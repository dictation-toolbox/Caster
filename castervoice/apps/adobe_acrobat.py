...
class AcrobatRule(MergeRule):
 ...
 # Sticky Note Commands
        ...
        "scroll <speed_one_to_nine>": R(Key("cs-h/2, %(speed_one_to_nine)s"), rdescript="scroll <speed_one_to_nine>"),
        "scroll": R(Key("cs-h/2, 6"), rdescript="scroll"),
        "change speed <speed_one_to_nine>": R(Key("%(speed_one_to_nine)s, %(speed_one_to_nine)s"), rdescript="change speed <speed_one_to_nine>"),
        ...
        "highlight": R(Key("u"), rdescript="highlight"),
        "hand tool": R(Key("h"), rdescript="hand tool"),
        "select tool": R(Key("v"), rdescript="select tool"),
