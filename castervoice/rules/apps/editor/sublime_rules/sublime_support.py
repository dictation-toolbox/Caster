try : 
	from sublime_rules.snippet_utilities import placeholder,regular,regex,load_snippets
	...
	from castervoice.rules.apps.editor.sublime_rules.snippet_utilities import placeholder,regular,regex,load_snippets
