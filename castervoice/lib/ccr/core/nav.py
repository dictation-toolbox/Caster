...
class Navigation(MergeRule):
    ...
    # text formatting
        ...
        "(lease wally | lairch) [<nnavi10>]": R(Key("home:%(nnavi10)s")),
        "(ross wally | rairch) [<nnavi10>]": R(Key("end:%(nnavi10)s")),
        "sauce wally": R(Key("c-home")),
        "dunce wally": R(Key("c-end")),
        "(shin | que) sauce wally": R(Key("cs-home")),
        "(shin | que) dunce wally": R(Key("cs-end")),
