    ...
    mapping = {
        ...
        "try <exception>": 
            ...
            + Text("except %(exception)s:") + Pause("10") + Key("enter/2"),
                rdescript="Python: create 'try catch' block with given exception"),
        "try <exception> as": 
            R(Text("try :") + Pause("10") + Key("enter/2") + Text("except %(exception)s as :")
            + Pause("10") + Key("enter/2"),  
            rdescript="Python: create 'try catch as' block with given exception"),
        ...
        "standard <python_standard_library_module>": 
            R(Text(" %(python_standard_library_module)s "), 
            rdescript="Python: type name of Python standard library module"),
        "lib <python_library>": 
            R(Text(" %(python_library)s "),
            rdescript="Python: type name of Python nonstandard library"),
        "import <python_standard_library_module>": 
            R(Text("import %(python_standard_library_module)s "), 
            rdescript="Python: import module from Python standard library"),
        "import <python_library>":
            R(Text("import %(python_library)s "), rdescript="Python: import nonstandard library"),
    }
