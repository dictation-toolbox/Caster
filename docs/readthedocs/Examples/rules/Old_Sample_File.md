...
There's been a lot of documentation on how to construct a dragonfly grammar. However people learn in different ways, the following is a complete example called `sample.py`. The comments explain a lot of things which beginners might struggle with.
