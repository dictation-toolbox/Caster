...
- [Instructions for installing](caster/castervoice/doc/Installation.md)
...
- Caster Command Reference Guides 
  ...
  - [Program Languages](caster/castervoice/doc/readthedocs/CCR_languages_Quick_Reference.md) - Language specific coding - These modules are activated and deactivated with the `enable/disable <language>` voice command. For example say `enable python`. 
...
- The [Voice Index](caster/castervoice/doc/readthedocs/Voice_Index.md) is a curated source of information: Videos, Blogs, Repositories, Presentations, etc related to Dragonfly, voice programming, and accessibility.
...
- Third-party Integrations
  ...
  - [Sikulix](http://sikulix.com/) - [Setup](caster/castervoice/doc/readthedocs/Sikuli.md): Automates anything you see on the screen of your desktop computer. - [Demo](https://youtu.be/RFdsD2OgDzk?list=PLV6JPhkq1x8LHu02YefhUU9rXiB2PK8tc&t=512)
  - [Aenea](https://github.com/dictation-toolbox/aenea) - [Setup](caster/castervoice/doc/readthedocs/Aenea.md): A client-server library for using voice macros from Dragon NaturallySpeaking and Dragonfly on remote/non-windows hosts.
