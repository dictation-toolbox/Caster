                    ...
                    if extension in acceptable_extensions:
                        ...
                        if "directories" in self.TOTAL_SAVED_INFO:
                            if absolute_path in self.TOTAL_SAVED_INFO["directories"][directory]["files"]:
                                old_sticky_list=self.TOTAL_SAVED_INFO["directories"][directory]["files"][absolute_path]["sticky"]
                                old_added_list=self.TOTAL_SAVED_INFO["directories"][directory]["files"][absolute_path]["added"]
                                old_banned_list=self.TOTAL_SAVED_INFO["directories"][directory]["files"][absolute_path]["banned"]
                        ...
                        scanned_file["banned"]=old_banned_list
                        ...
                        for line in lines:
                            ...
                            for result in filter_results:                                
                                if not (result in scanned_file["banned"] or result in scanned_file["names"] or result in scanned_file["sticky"] or result in old_sticky_list) and not result=="":
