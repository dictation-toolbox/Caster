...
"""
Command-module for Hearthstone
...
class CommandRule(MappingRule):
    ...
    mapping = {
        "give alpha [<level>]":                    Text("s") * Repeat(extra="level"),
...
context = AppContext(executable="Hearthstone")
grammar = Grammar("Hearthstone", context=context)
