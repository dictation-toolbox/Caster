...
class AppsModulesTestCase(ModulesTestCase):
    def _rule_modules(self):
        ...
        from castervoice.rules.apps.editor.sublime_rules import sublime_snippet_additional_control
        ...
        return [chrome, firefox, jetbrains, adobe_acrobat, atom,
                ...
                sqldeveloper, ssms, sublime, sublime_snippet_additional_control,totalcmd, totalcmd2,
